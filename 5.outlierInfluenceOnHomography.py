...
def drawMatchPairsWithOutliers(x_data1, y_data1, x_data2, y_data2, indices, i, color="lightgreen"):
    plt.title("Data with " + i.__str__() + " outliers")
...
if __name__ == '__main__':
    ...
    for i in range(10):
        print "Number of outlier:", i + 1
        x_data1_o, y_data1_o, x_data2_o, y_data2_o, indices = addOutliersToPointPair(x_data1_n, y_data1_n,
                                                                                     x_data2_n, y_data2_n,
                                                                                     i)
        h = lsp_svd(x_data1_o, y_data1_o, x_data2_o, y_data2_o)
        print "Homography matrix:\n", h

        checkAccuracy(x_data1_o, y_data1_o, x_data2_o, y_data2_o, h)

        drawMatchPairsWithOutliers(x_data1_o, y_data1_o, x_data2_o, y_data2_o, indices, i)
