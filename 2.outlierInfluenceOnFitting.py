...
if __name__ == '__main__':
    for i in range(10):
        ...
        # make a outlier to show the influence on estimation
        print "y_data_noise[50]:", y_data_noise[50], "->", y_data_noise[50] + i * 15
        y_data_noise[50] += i * 15
        ...
        plt.title("Data with one outlier")
        plt.tight_layout()
        ...
        plt.scatter(x_data_noise[50], y_data_noise[50], color='red', label='outlier')
        plt.legend()
        plt.show()
